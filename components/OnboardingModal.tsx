    ...
    return (
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-white/90 dark:bg-black/90 backdrop-blur-xl transition-colors">
        <div className="flex flex-col items-center animate-[fadeIn_0.5s_ease-out]">
          <Loader2
            size={48}
            className="text-charcoal dark:text-white animate-spin mb-6"
            strokeWidth={1.5}
          />
      ...
      <div className="w-full max-w-lg bg-white dark:bg-[#1a1a1a] rounded-[2.5rem] shadow-2xl dark:shadow-black/60 p-8 sm:p-10 relative overflow-hidden animate-[scaleIn_0.4s_cubic-bezier(0.16,1,0.3,1)] border border-stone-100 dark:border-white/10 transition-all">
        {step <= totalSteps && (
          <div className="absolute top-0 left-0 h-1.5 bg-stone-100 dark:bg-[#202020] w-full">
            <div
              className="h-full bg-charcoal dark:bg-forest transition-all duration-500"
        ...
        {step === 1 && (
          <div className="space-y-8 animate-[fadeIn_0.5s_ease-out]">
            <div className="w-14 h-14 bg-stone-50 dark:bg-[#161616] rounded-2xl flex items-center justify-center text-charcoal dark:text-white shadow-sm mb-4">
              <Activity size={24} />
            </div>
            <div>
            ...
            <div className="group">
              ...
              <input
                ...
                readOnly
                disabled
                className="w-full bg-stone-50 dark:bg-[#161616] border-2 border-sand dark:border-white/10 rounded-[1.5rem] py-5 px-6 font-black text-xl outline-none text-stone-500 dark:text-stone-400 cursor-not-allowed transition-colors"
              />
            </div>
          </div>
        )}
            ...
            <div className="py-4">
              <div className="flex justify-between items-end mb-6">
                <span className="text-4xl font-black text-charcoal dark:text-white">
                  {severityIndex}
                  <span className="text-sm text-stone-300 dark:text-stone-600">/10</span>
                </span>
              </div>
              <input
                type="range"
        ...
        {step === 5 && archetype && (
          <div className="space-y-8 animate-[scaleIn_0.6s_cubic-bezier(0.16,1,0.3,1)] text-center">
            <div className="flex justify-center mb-4">
              <div className="w-20 h-20 bg-forest text-white rounded-[2rem] rotate-3 flex items-center justify-center shadow-2xl text-4xl">
                {archetype.icon}
              </div>
            </div>
            <div>
              ...
              <p className="text-stone-500 dark:text-stone-400 font-serif italic text-lg leading-relaxed max-w-sm mx-auto">
