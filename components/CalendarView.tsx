          ...
          {items.map((item, idx) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0 py-1">
                ...
                <p className="text-[10px] font-bold text-stone-400 dark:text-stone-400 mb-2 truncate">
                  {item.movie.director}
                </p>
                <div className="flex items-center gap-2">
                  <div className="bg-charcoal dark:bg-forest text-white px-2 py-1 rounded-lg flex items-center gap-1">
                    ...
                    <span className="text-[10px] font-bold">
                      {(
                        (item.movie.ratings.story +
                          item.movie.ratings.visuals +
                          item.movie.ratings.acting +
                          item.movie.ratings.sound) /
                        4
                      ).toFixed(1)}
                    </span>
                  </div>
        ...
        <div className="bg-white dark:bg-[#1a1a1a] rounded-full shadow-sm dark:shadow-black/20 border border-stone-100 dark:border-white/10 py-3 px-4 flex items-center justify-between mx-auto max-w-sm transition-all">
          {viewMode === 'month' ? (
            <button
              ...
              className="p-2 hover:bg-stone-50 dark:hover:bg-[#202020] rounded-full transition-colors text-charcoal dark:text-white active:scale-90"
            >
          ...
          <div className="text-center flex-1">
            {viewMode === 'month' ? (
              <>
                <h2 className="text-sm font-black text-charcoal dark:text-white tracking-widest uppercase leading-none">
                  {MONTHS[month]} {year}
                </h2>
              ...
              <>
                ...
                <div className="text-[9px] font-bold text-stone-300 dark:text-stone-500 mt-1 uppercase tracking-widest">
                  {yearData.reduce((a, b) => a + b, 0)} Séances
                </div>
              </>
            )}
          </div>
