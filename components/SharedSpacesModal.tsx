        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 no-scrollbar">
          ...
          {loading && spaces.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-10 gap-3">
              ...
              <p className="text-[10px] font-black uppercase text-stone-300 tracking-widest">
                Synchronisation...
              </p>
            </div>
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-3">
                        ...
                        <h4 className="font-black text-base text-charcoal group-hover:text-forest transition-colors">
                          {space.name}
                        </h4>
                      </div>
                      <button
                    ...
                    {space.description ? (
                      <p className="text-xs text-stone-500 font-medium pl-11 line-clamp-1">
                        {space.description}
                      </p>
                    ) : (
            ...
            <div className="py-10 text-center space-y-4">
              ...
              <p className="text-sm font-medium text-stone-500 max-w-[200px] mx-auto">
                Vous ne participez à aucun espace partagé pour le moment.
              </p>
            </div>
          ) : null}
            ...
            {!showCreateForm && !showJoinForm ? (
              ...
              <div className="bg-white border border-sand rounded-[2rem] p-6 animate-[fadeIn_0.3s_ease-out] shadow-xl">
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-2 bg-stone-100 rounded-lg text-charcoal">
                    <Plus size={16} />
                  </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase text-stone-400 tracking-widest ml-1">
                      Nom
                    </label>
                    <input
                      type="text"
