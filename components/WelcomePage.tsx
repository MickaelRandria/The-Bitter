      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 sm:px-10 relative z-10 w-full max-w-xl mx-auto">
                ...
                <>
                  ...
                  >
                    <div className="flex items-center gap-5">
                      <Users size={22} strokeWidth={2} /> Mes Profils
                    </div>
                    <ArrowRight
                      size={22}
          ...
          <div className="w-full animate-[fadeIn_0.5s_ease-out]">
            <div className="mb-10 flex justify-between items-end">
              <div className="text-left">
                ...
                <p className="text-stone-400 font-bold text-base">
                  Choisissez votre carnet de bord.
                </p>
              </div>
              {existingProfiles.length > 0 && (
                <button
            ...
            {existingProfiles.length > 0 ? (
              ...
              <div className="py-20 flex flex-col items-center text-center animate-[fadeIn_0.5s_ease-out]">
                ...
                <p className="text-stone-400 text-sm max-w-[240px] mb-10 leading-relaxed">
                  Commencez votre héritage cinématographique en créant votre premier compte.
                </p>
                <button
                  onClick={() => {
                    haptics.medium();
                  ...
                  className="bg-charcoal text-white px-8 py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-xl flex items-center gap-3 active:scale-95 transition-all"
                >
        ...
        {step === 'create' && (
          <form
            ...
            className="w-full animate-[slideUp_0.5s_ease-out] pb-20 no-scrollbar max-h-[80vh] overflow-y-auto pr-2 mt-12"
          >
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-6 items-end">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    />
                    <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] font-black text-stone-400 uppercase">
                      ANS
                    </span>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <button
                    ...
                    onClick={() => {
                      haptics.medium();
                      setFormData({ ...formData, viewingPreference: 'streaming' });
                    }}
                  ...
                  <button
                    ...
                    onClick={() => {
                      haptics.medium();
                      setFormData({ ...formData, viewingPreference: 'cinema' });
                    }}
                  ...
                  <button
                    ...
                    onClick={() => {
                      haptics.medium();
                      setFormData({ ...formData, viewingPreference: 'both' });
                    }}
              ...
              {(formData.viewingPreference === 'streaming' ||
                formData.viewingPreference === 'both') && (
                <div className="animate-[fadeIn_0.3s_ease-out] space-y-4">
                  <label className="text-[11px] font-black uppercase text-stone-500 tracking-[0.2em] block ml-1">
                    Vos plateformes favorites
                  </label>
        ...
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-6">
          ...
          <div className="bg-white p-8 rounded-[2.5rem] shadow-2xl relative z-10 w-full max-w-sm text-center animate-[scaleIn_0.3s_cubic-bezier(0.16,1,0.3,1)]">
            ...
            <p className="text-stone-400 font-medium text-sm leading-relaxed mb-8">
              Cette action supprimera définitivement le profil et tout son historique. C'est
              irréversible.
            </p>
