          ...
          <div className="text-center animate-[slideUp_0.6s_ease-out] w-full flex flex-col items-center">
            ...
            <div className="space-y-5 w-full max-w-sm sm:max-w-md">
              {existingProfiles.length > 0 ? (
                <>
                  <button
                    onClick={() => { haptics.medium(); setStep('select'); }}
                  ...
                  >
                    <div className="flex items-center gap-5">
                      <Users size={22} strokeWidth={2} /> {t('welcome.myProfiles')}
                    </div>
          ...
          <div className="w-full animate-[fadeIn_0.5s_ease-out]">
            ...
            {existingProfiles.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[11px] font-black uppercase text-stone-400 tracking-[0.1em] mt-1">
                          {p.movies.length} {t('welcome.films')}
                        </p>
                      </div>
                      {isManaging && (
                        <button
              ...
              <div className="py-20 flex flex-col items-center text-center animate-[fadeIn_0.5s_ease-out]">
                ...
                >
                  <UserPlus size={16} /> {t('welcome.createProfile')}
                </button>
              </div>
            )}
          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    { val: 'streaming', icon: <Tv size={24} />, label: t('createProfile.stream') },
                    { val: 'cinema', icon: <Ticket size={24} />, label: t('createProfile.cinema') },
                    { val: 'both', icon: <Clapperboard size={24} />, label: t('createProfile.both') },
                  ].map(({ val, icon, label }) => (
                    <button
                      key={val}
                      type="button"
