      ...
      <div className="bg-white w-full max-w-md rounded-[2rem] shadow-2xl border border-stone-200 p-6 pointer-events-auto animate-[slideUp_0.4s_cubic-bezier(0.16,1,0.3,1)] relative overflow-hidden">
        ...
        <div className="flex flex-col relative z-10">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              <h3 className="text-lg font-black text-charcoal tracking-tight leading-none mb-2">
                Cookies & Confidentialité
              </h3>
              <p className="text-xs font-medium text-stone-500 leading-relaxed">
                Nous utilisons des traceurs anonymes pour comprendre comment vous utilisez{' '}
                <span className="font-bold text-charcoal">The Bitter</span> et améliorer votre
                expérience. Aucune donnée personnelle n'est revendue.
              </p>
            </div>
          </div>
