  ...
  return (
    <div className="min-h-screen bg-cream flex flex-col relative overflow-hidden font-sans selection:bg-forest selection:text-white">
      ...
      {step !== 'landing' && (
        <button 
          onClick={goBack} 
          className="absolute top-[calc(2rem+env(safe-area-inset-top))] left-6 z-50 flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-md rounded-full border border-sand shadow-sm active:scale-95 transition-all group"
        >
